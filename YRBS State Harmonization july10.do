...
*capture cd "C:\Users\ammar\OneDrive\Desktop\CHEPS\YRBS\State" // ALICIA
// INSERT CD HERE
// INSERT CD HERE
end
setcd
...
weight stratum psu year fips bmipct grades sex motorcycle_helmet 
seatbelt hurtself oralsex pregnant dietpills athsma breakfast fasting */

*age and grade are in real numbers (age 14 or grade 9) instead of 1,2,3,etc. 
replace age=1 if age==12
replace age=2 if age==13
replace age=3 if age==14
replace age=4 if age==15
replace age=5 if age==16
replace age=6 if age==17
...
gen tobaccochew3 = snuff_use_30days
gen getcigarettes3 = cigs_obtain
gen tobaccochew = tobacco_snuff
gen chewtobschool3 = tobacco_snuff_schoolnew
...
tobacco_age inhaled_age stop_smoking talkwithparent prevent
...
qcigschool tobaccochew getcigarettes3 cigarsmoke getcigarettes2 ///
...
bornusa skipped_school_new militaryfamily alch_location_new birthcontrol5 ///
...
orgactivities job_hours volunteer_hours cavities dentist_reason cigs_tv cigs_ads ///
cigs_dangers cigs_professional peanuts_allergy peanuts_7days asthma_plan ///
diabetes_exercise diabetes_specdiet tobaccochew3 chewtobschool3 tobaccochew
