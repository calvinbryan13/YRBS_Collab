...
capture cd "/Users/Kevin/Documents/GitHub/CHEPS/SEER"
********************
*** SEER WEIGHTS ***
********************
clear
...
import delimited "us.1990_2017.19ages.adjusted.txt", delimiter("") clear 
...
replace race4 = 4 if race == "3" & origin=="0" | race== "4" & origin=="0"
...
save "seer_weights2017.dta", replace
